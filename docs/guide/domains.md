...
| Type | Name | Value |
|------|------|-------|
| TXT | <CopyText text="tosend._domainkey" /> | <CopyText text="MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQDFlPZ1FmKv/l3JoSBHRhkaVu1rmv16nScF/J0UW5SQjm2Pzw8MZ2dTotaCJ7A6v4cUzbOqI3IPQUTZocxzn+2doySXLRWVlbqsrQ8rZiACpsJwug/1Qmxeo7EAV5i5fPC99AF6YBATH0xY9yvO9d9rnt5sum8o/dpU5zuWbirJnQIDAQAB" /> |
...
| Type | Name | Value |
|------|------|-------|
| TXT | <CopyText text="send" /> | <CopyText text="v=spf1 include:amazonses.com ~all" /> |
...
|------|------|----------|-------|
| MX | <CopyText text="send" /> | 10 | <CopyText text="feedback-smtp.us-east-1.amazonses.com" /> |
...
| Type | Name | Value |
|------|------|-------|
| TXT | <CopyText text="_dmarc" /> | <CopyText text="v=DMARC1; p=none;" /> |
